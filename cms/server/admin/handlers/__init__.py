...
from cms.server.admin.handlers.contestemotion import AddQuestionsEmotionsHandler, AllEmotionsHandler, AllFormEmotionsHandler, FormEmotionHandler, FormEmotionUserResponseHandler
from .admin import \
    AddAdminHandler, \
    AdminsHandler, \
    AdminHandler
...
HANDLERS = [
    ...
    # Emotions
    (r"/question_emotions/add", AddQuestionsEmotionsHandler),
    (r"/contest/emotions", AddQuestionsEmotionsHandler),

    (r"/contest/([0-9]+)/emotions_submissions", AllEmotionsHandler),
    (r"/contest/([0-9]+)/emotions_submissions/([0-9]+)", FormEmotionUserResponseHandler),


    (r"/question_emotions/([0-9]+)", FormEmotionHandler),
    (r"/question_emotions", AllFormEmotionsHandler),
