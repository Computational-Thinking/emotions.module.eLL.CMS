...
class FormsEmotions(Base):
    __tablename__ = 'forms_emotions'

    id = Column(Integer, primary_key=True)
    name = Column(Unicode)
    questions = Column(Unicode)

    emotions = relationship(
        "Emotion",
        back_populates="form_emotion"
    )
...
class Emotion(Base):
    ...
    emotion_timestamp = Column(DateTime)
    ...
    emotions = Column(Unicode)

    form_emotion_id = Column(
        Integer,
        ForeignKey(FormsEmotions.id,
                   onupdate="CASCADE", ondelete="CASCADE"),
        nullable=False,
        index=True)
    form_emotion = relationship(
        FormsEmotions,
        back_populates="emotions")
